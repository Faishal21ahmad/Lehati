...
<a href="{{ Route('room.detail', $data->room_code) }}"  >
    <div class="w-59 h-80 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 ">
        <div class="h-40 overflow-hidden flex justify-center items-center rounded-t-lg">
        ...
        <div class="p-4 overflow ">
            ...
            <p class="mb-3 font-normal text-sm text-gray-700 dark:text-gray-400">Starting ... Rp. {{ number_format($data->starting_price, 0, ',', '.') }}</p>
            ...
            <p class="mb-3 font-normal text-sm text-gray-700 dark:text-gray-400 truncate">{{ \Carbon\Carbon::parse($data->start_time)->translatedFormat('l, d F Y H:i') }}</p>
