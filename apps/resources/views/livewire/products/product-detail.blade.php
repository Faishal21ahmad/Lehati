<div class="px-6 pt-2 md:p-8 md:ml-64 text-black dark:text-white">
    <x-layouts.app-header :title="__('Detail Product')" :description="__('Create New Your Product')" />
    
   
    {{-- <livewire:component.carousel > --}}
    <x-carousel.carousel :fileproduct="$fileproduct" class="w-2/4" />
    {{-- @dd($fileproduct) --}}
    <div class="lg:w-1/2">
